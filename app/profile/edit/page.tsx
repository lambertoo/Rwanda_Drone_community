            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  ...
                  {(profile as any)?.googleLinked ? (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded-md bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-400">
                      Connected
                    </span>
                  ) : (
                    <Button
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {(profile as any)?.googleSheetsConnected
                          ? "Google Sheets access is authorized"
                          : "Authorize to sync form responses to Google Sheets"}
                      </p>
                    </div>
                  </div>
                  {(profile as any)?.googleSheetsConnected ? (
