...
const DEFAULT_ZONES = [
  ...
  { name: "Kigali Intl Airport Bugesera (HRKI) — Ban Zone", description: "5km full ban. New Kigali International Airport — Bugesera (parallel runways 14L/32R & 14R/32L). CAA authorization required.", type: "airport", lat: -2.142956, lon: 30.180916, radius: 5, severity: "red", province: "Eastern" },
  { name: "Kigali Intl Airport Bugesera — Advisory Zone", description: "10km advisory zone around new Kigali International Airport Bugesera. Prior notification required.", type: "advisory", lat: -2.142956, lon: 30.180916, radius: 10, severity: "orange", province: "Eastern" },
  { name: "Kamembe Airport (HRZA) — Ban Zone", description: "3km full ban around Kamembe Airport. No drone operations without CAA authorization.", type: "airport", lat: -2.462252, lon: 28.907982, radius: 3, severity: "red", province: "Western" },
  { name: "Kamembe Airport (HRZA) — Advisory Zone", description: "5km advisory zone around Kamembe Airport. Prior notification required.", type: "advisory", lat: -2.462252, lon: 28.907982, radius: 5, severity: "orange", province: "Western" },
  { name: "Huye Airport — Ban Zone", description: "3km full ban around Huye Airport. No drone operations without CAA authorization.", type: "airport", lat: -2.595325, lon: 29.735554, radius: 3, severity: "red", province: "Southern" },
  // Protected areas
