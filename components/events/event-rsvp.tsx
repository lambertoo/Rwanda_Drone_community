...
export default function EventRSVP({
    ...
    return (
      <div className="bg-background rounded-lg border p-6 space-y-4">
        <div className="text-center">
          <XCircle className="h-12 w-12 text-muted-foreground/70 mx-auto mb-2" />
  ...
  const spotsLeft = capacity ? capacity - registeredCount : null
  ...
  if (isPastEvent) {
    return (
      <div className="bg-background rounded-lg border p-6 space-y-4">
        <div className="text-center">
          <Calendar className="h-12 w-12 text-muted-foreground/70 mx-auto mb-2" />
          <h3 className="text-lg font-semibold text-foreground mb-2">
            Event Has Passed
          </h3>
          <p className="text-muted-foreground dark:text-muted-foreground/70">
  ...
  return (
    <div className="bg-background rounded-lg border p-6 space-y-4">
      ...
      <div className="space-y-3">
        ...
        {capacity && (
          <div className="text-sm">
            {isAtCapacity ? (
              <span className="text-red-600 font-medium">Waitlist available</span>
            ) : spotsLeft !== null && spotsLeft <= 10 ? (
              <span className="text-orange-600 font-medium">{spotsLeft} spot{spotsLeft === 1 ? '' : 's'} left</span>
            ) : (
      ...
      {user ? (
        ...
        <div className="text-center">
          <p className="text-sm text-muted-foreground dark:text-muted-foreground/70 mb-3">
