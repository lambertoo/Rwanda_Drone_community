...
import { Plus, X, Upload, Eye, Calendar, MapPin, Users, CheckCircle, AlertCircle, Edit } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.project) {
        ...
        showNotification('success', 'Project Updated!', 'Project updated successfully! Redirecting to project page...')
